  ...
  <div>
    ...
    >
      ...
      <div style="display: flex">
        ...
        <div style="flex: 1">
          <a-form-model-item label="已扣税前销售总价">{{
            pretaxItemPriceDeduct
          }}</a-form-model-item>
          <a-form-model-item label="已扣税后销售总价">{{
            itemPriceDeduct
          }}</a-form-model-item>
          <a-form-model-item label="已扣税前优惠总价">{{
            pretaxReducedPriceDeduct
          }}</a-form-model-item>
          <a-form-model-item label="已扣税后优惠总价">{{
            reducedPriceDeduct
          }}</a-form-model-item>
        </div>
      </div>
