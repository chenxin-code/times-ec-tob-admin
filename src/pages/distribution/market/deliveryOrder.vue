        ...
        <div class="item-list">
          <div>
            <div
              class="img-box"
              v-if="
                dataListDetail.deliveryProofImgList &&
                  dataListDetail.deliveryProofImgList.length > 0
              "
            >
        ...
        <div class="item-list" v-if="dataListDetail.approveStatus != 0">
          <div>
            ...
            <div
              class="img-box"
              v-if="
                dataListDetail.receiverProofImgList &&
                  dataListDetail.receiverProofImgList.length > 0
              "
            >
    ...
    signFor(row) {
      this.$confirm({
        ...
        onOk: () => {
          let params = {
            deliveryNo: row.deliveryNo,
            receiverProofImgs: row.receiverProofImgs
              ? row.receiverProofImgs
              : [],
            receiveType: 0,
            itemList: [],
          }
